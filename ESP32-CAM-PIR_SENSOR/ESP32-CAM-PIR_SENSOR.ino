...
//#define SSID        "TG Staff"   //WiFi name F8
//#define PASSWORD    "improve8"   //PASSWORD F8
#define SSID        "F7 TG Device"   //WiFi name F7
#define PASSWORD    "F07#APDEVICE@"   //PASSWORD F7
#define LINE_TOKEN  "L3tP9zKDDOWu8lgJ6D7EKqiWbfqRdZ0XGsOXXWzimT8" // testing group line CAM
//#define LINE_TOKEN  "X9i4GdCSZkbZgd4YseLdxAqSChWYmOSo63j92JKwDuE"   // main group line ELEC
